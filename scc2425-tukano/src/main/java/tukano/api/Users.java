...
public interface Users {
	 ...
	 */
	Result<String> createUser(UserDB user);
	 ...
	 */
	Result<UserDB> getUser(String userId, String pwd);
	 ...
	 *         BAD_REQUEST - otherwise.
	 */
	Result<UserDB> updateUser(String userId, String pwd, UserDB user);
	 ...
	 *         BAD_REQUEST otherwise
	 */
	Result<UserDB> deleteUser(String userId, String pwd);
	 ...
	 *         BAD_REQUEST - otherwise.
	 */
	Result<List<UserDB>> searchUsers(String pattern);
}

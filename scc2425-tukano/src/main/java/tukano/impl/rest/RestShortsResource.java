...
public class RestShortsResource extends RestResource implements RestShorts {
	...
	@Override
	public void follow(String userId1, String userId2, BooleanData isFollowing, String password) {
	...
	@Override
	public void like(String shortId, String userId, BooleanData isLiked, String password) {
